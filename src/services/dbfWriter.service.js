...
function crearValorCampo(
    ...
    switch (
        ...
        default:
            ...
            throw new Error(
                `Tipo DBF no soportado: ${campo.tipo}`
            );
    }
}
...
function escribirDBF(
    ...
    if (
        ...
        throw new Error(
            'No existen registros para generar el DBF.'
        );
    }

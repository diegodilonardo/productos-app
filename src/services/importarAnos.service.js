...
async function importarAnos() {

    const maestro = maestros.ANOS;
    ...
    try {
        ...
        for (let i = 0; i < filas.length; i++) {
            ...
            if (!codigo) {
                ...
                throw new Error(
                    `Código de año vacío en línea ${i + 1}.`
                );
            }
            ...
            if (!detalle) {
                ...
                throw new Error(
                    `Detalle de año vacío en línea ${i + 1}.`
                );
            }
        ...
        try {
            ...
            /* =================================================
               8. LIMPIAR STAGING DE ESTA IMPORTACIÓN
               ================================================= */
            ...
            await new sql.Request(transaction)
                ...
                .query(`
                    DELETE FROM dbo.STG_MAESTRO_ANOS
            ...
            for (const registro of registros) {
                ...
                await new sql.Request(transaction)
                    ...
                    .query(`
                        INSERT INTO dbo.STG_MAESTRO_ANOS
                        (
                            ID_IMPORTACION,
                            CODIGO_ANO,
                            DETALLE_ANO
            ...
            const nuevosResult =
                await new sql.Request(transaction)
                    ...
                    .query(`
                        SELECT
                            COUNT(*) AS CANTIDAD
                        FROM dbo.STG_MAESTRO_ANOS T
                        LEFT JOIN dbo.MAESTRO_ANOS M
                            ON M.CODIGO_ANO =
                               T.CODIGO_ANO
                        WHERE
                            T.ID_IMPORTACION =
                                @ID_IMPORTACION
                            AND M.CODIGO_ANO IS NULL;
                    `);
            ...
            const inactivosResult =
                await new sql.Request(transaction)
                    ...
                    .query(`
                        SELECT
                            COUNT(*) AS CANTIDAD
                        FROM dbo.MAESTRO_ANOS M
                        LEFT JOIN dbo.STG_MAESTRO_ANOS T
                            ON T.CODIGO_ANO =
                               M.CODIGO_ANO
                            AND T.ID_IMPORTACION =
                                @ID_IMPORTACION
                        WHERE
                            T.CODIGO_ANO IS NULL
                            AND M.ACTIVO = 1;
                    `);
            ...
            await new sql.Request(transaction)
                ...
                .query(`
                    ...
                    INNER JOIN dbo.STG_MAESTRO_ANOS T
                        ON T.CODIGO_ANO =
                           M.CODIGO_ANO
            ...
            /* =================================================
               15. INACTIVAR LOS QUE YA NO EXISTEN
               ================================================= */

...
function exportarConsultaMaestros(tipoEntrada, filasEntrada) {
  ...
  const campos = {
    ...
    PROVEEDORES: ['CODIGO','NVA_RAZON_SOCIAL','PRESEA','RUBRO'],
    PRODUCTOS: ['CODIGO_ALFA','CODIGO_ERP','CODIGO_EAN','TIPO_PRODUCTO','TIPO_PRODUCTO_DETALLE','C_ESTADIO','ESTADO_PRODUCTO','GENERADO_AUTOMATICO','DETALLE_PRODUCTO','CODIGO_MODELO','DETALLE_MODELO','CODIGO_COLOR','DETALLE_COLOR','TALLE_MODULO','DETALLE_MARCA','DETALLE_RUBRO','LICENCIA','CODIGO_ALTA','ESTADO_ALTA','FECHA_CARGA','FECHA_ACTUALIZACION','FECHA_ULTIMA_SYNC']
  }[tipo];
